...
export default function ProfileView({ profile }: any) {
  ...
  console.log(profile, 'profile in profile');
  return (
    <>
        ...
        <div className="overflow-hidden rounded-lg bg-white shadow">
          ...
          >
            ...
            >
              ...
              >
                <img src={'/assets/images/upload.svg'} className="mr-2" />
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
              <div className="sm:flex sm:items-center sm:space-x-5">
                ...
                <div className="mt-4 text-center sm:mt-0 sm:pt-1 sm:text-left">
                  <div className="educationCard">
                    <p className="text-xl font-bold text-[#4E5D78] sm:text-2xl">
                      {`${profile.error ? 'Saleh Ahmed' : profile.firstName} ${profile.error ? '' : profile.lastName
                        }`}
                    </p>
                ...
                <button
                  ...
                  className="hover: mobMessage mt-[-15px] inline-flex justify-center rounded-md border border-[#377DFF] bg-white px-6 px-4 py-2 pl-6 text-sm  font-medium text-[#377DFF] shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                >
                  <span>Message</span>
                </button>
              </div>
      ...
      <section
        ...
        className={profile?.summary != undefined ? '' : ''}
      >
          ...
          <div className="px-0 pb-0">
            ...
            <dl className="justify grid grid-cols-1 gap-x-4 gap-y-8 px-8 pb-4 text-lg text-base text-gray-500 sm:grid-cols-3">
              <div className="sm:col-span-6">
                ...
                <dd
                  className="mt-1 max-w-full px-4 pb-2 text-sm text-gray-500"
                // dangerouslySetInnerHTML={{
                //   __html: profile?.summary,
                // }}
                />
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nisi
                nisi vitae adipiscing erat urna elit nulla. Faucibus ac eget
                pellentesque neque dui sociis. Nisi, morbi malesuada varius
                dapibus cras. Morbi quis morbi orci placerat turpis.Lorem ipsum
                dolor sit amet, consectetur adipiscing elit. Nisi nisi vitae
                adipiscing erat urna elit nulla. Faucibus ac eget pellentesque
                neque dui sociis{' '}
              </div>
            </dl>
          </div>
      ...
      >
        <div className="overflow-hidden rounded-lg bg-white  py-4 shadow">
          <div className="px-0 pb-0">
            <div className="mb-2 border-0 border-b-2 border-slate-100 px-4 sm:col-span-6">
              <dt className="mobHead px-4 pb-4 text-3xl font-semibold text-[#4E5D78]">
                Business info
              </dt>
            </div>
            <div className="grid grid-cols-3 border-0 px-8 px-4 pb-4 text-center text-[#4E5D78] sm:grid-cols-3 sm:text-left">
              <div className="fnsizee text-lg font-semibold">Business Name</div>
              <div className="fnsizee text-lg font-semibold">Industry</div>
              <div className="fnsizee text-lg font-semibold">
                Business Stage
              </div>
            </div>
            <div className="grid grid-cols-3 px-8 px-4 pb-4 pt-4 pb-4  text-center text-[#4E5D78] sm:grid-cols-3 sm:text-left">
            ...
            <div className="mt-2 grid grid-cols-3 px-8  px-4 pb-4 text-center text-[#4E5D78] sm:grid-cols-3 sm:text-left">
              <div className="fnsizee text-lg font-semibold">Amount Raised</div>
      ...
      >
        <div className="overflow-hidden rounded-lg bg-white  py-4 shadow">
          <div className="px-0 pb-0">
            ...
            <div className="grid grid-cols-2  place-items-center px-8 md:grid-cols-4">
              {profile?.skills?.map((skil: any, index: number) => {
                ...
                return (
                  <div
                    key={skil + '-' + index}
                    className={
                      'skilsss mb-5 flex max-w-[170px] flex-col items-center justify-center rounded-xl border border-slate-200 p-5'
                    }
                  >
