  ...
  return (
    <>
      ...
      <form
        ...
        className="flex space-x-4 rounded-md px-4 py-3 focus-within:bg-gray-50 hover:bg-gray-50"
      >
        <div className="flex-shrink-0">
        ...
        <div className="w-full">
          <div className="flex flex-col items-center">
            <textarea
              ...
              disabled={!discussion}
              className="w-full resize-none rounded border-gray-300 px-3 text-base"
              placeholder="Reply…"
              rows={1}
            ></textarea>
            <div className="mt-2 flex w-full justify-end">
              <button
                ...
                className="inline-flex items-center justify-center rounded-md border border-transparent bg-blue-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-100 disabled:bg-gray-500"
              >
                Post
              </button>
            </div>
...
export default function DiscussionCard({
  ...
  const handleUpvote = async () => {
    try {
      await axios.post(`${NEXT_URL}/api/session/discussions/${data.id}/vote`, {
        score: 1,
      });
