  ...
  social: [
    {
      ...
      img: '/assets/images/faceSocial.svg',
      icon: (props: any) => (
    ...
    },
    {
      ...
      img: '/assets/images/twitterSocial.svg',
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    },
    {
      ...
      img: '/assets/images/instaSocial.svg',
    ...
    },
    {
      ...
      img: '/assets/images/linkSocial.svg',
        ...
        <div className="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
          <div className="mb-12 space-y-8 lg:col-span-1">
            <Link href="/">
              ...
              />
              <img
                className="block h-7 w-auto sm:h-9 xl:hidden"
          ...
          <div className="text-center sm:text-left lg:grid lg:grid-cols-3 lg:gap-8">
            <div className="mt-12 md:grid md:grid-cols-2 md:gap-8 lg:col-span-3 lg:mt-0">
              ...
              <div className="sm:items-left mt-8 flex w-full flex-col items-center sm:mt-0 sm:w-1/2">
                <h4 className="font-sans text-sm font-semibold uppercase">
              ...
              {/* TODO: signup for newsletter */}
              {/* <div className="mt-12 sm:w-full sm:max-w-md lg:mt-0 lg:flex-1">
                <h2 className="mt-0 mb-7 text-2xl font-extrabold tracking-tight leading-none text-blue-600">
                ...
                <form className="sm:flex">
                  ...
                  <input
                    ...
                    autoComplete="email"
                    required
                    className="w-full border-white px-4 py-2 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-blue-300 focus:ring-white rounded-md"
                    placeholder="Enter your email"
                  />
                  <button
                    type="submit"
                    className="mt-3 w-full flex items-center justify-center px-4 py-2 border border-transparent text-base font-medium rounded-md text-white bg-blue-400 hover:bg-blue-300 transition duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-blue-400 focus:ring-white sm:mt-0 sm:ml-3 sm:w-auto sm:flex-shrink-0"
                  >
                    Notify me
                  </button>
                </form>
                <p className="mt-4 text-sm text-gray-500 mb-5">
                ...
                {user.role?.type !== 'premium' && (
                  <Link
                    href="/premium"
                    className="whitespace-nowrap inline-flex items-center justify-center px-4 py-2 rounded-md shadow-sm text-base font-medium text-white text-shadow-default bg-gradient-to-bl bg-orange-500"
                  >
                    Try Premium
                  </Link>
                )}
          ...
          <div className="mt-12 block items-center justify-between border-t border-gray-400  pt-8 text-center sm:flex">
            ...
            <p className="text-base text-gray-400 ">
              {/* Copyright &copy; {new Date().getFullYear()} CoFoundersLab.{' '} */}
              2021 All Rights Reserved By CoFounders Lab
              {/* <Link
                href="/terms"
