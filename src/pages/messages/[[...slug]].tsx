  ...
  <>
    ...
    {position === 'left' ? (
      <>
        ...
        <div className="mt-2 flex w-full max-w-xs space-x-3 p-4 msgWidth">
          <div className="relative flex-shrink-0 mt-auto mb-5">
          ...
          <div className="flex flex-col items-start">
            <div className="flexTo">
              <div className="bgMessageBackground rounded-b-sm rounded-tr-2xl rounded-tl-2xl rounded-br-2xl pl-7 pr-7 pt-5 pb-5" style={{ width: "100%" }}>
                <p className="text-base text-white">{body}</p>
              </div>

              <Menu as="div" className="relative inline-block text-left flex items-center">
                <div>
                  <Menu.Button>
                    <img
                      className="ml-3 w-5"
      ...
      <div className="mt-2 ml-auto flex w-full max-w-xs justify-end space-x-3 p-4 msgWidth">
        <div className="flex flex-col items-end">
          <div className="flexTo">
            <Menu as="div" className="relative inline-block text-left flex items-center mr-3">
              <div>
                <Menu.Button>
                  <img
                    className="mr-5 w-5"
            ...
            <div className="bgSenderBackground rounded-bl-lg rounded-tl-lg rounded-tr-lg text-lg text-white pl-5 pr-5 pt-5 pb-5" style={{ width: "100%" }}>
...
export default function Messages() {
  ...
  const { data: connections } = useSWR(
    user ? `connections/me?status=accepted` : null,
    sessionGet
  );
  ...
  const onSubmit: SubmitHandler<IFormProps> = async (data) => {
    ...
    try {
      ...
      await mutate(`connections/me?status=accepted`);
  ...
  return (
    ...
    >
      ...
      >
        <div className="mx-auto h-full max-w-7xl px-4 py-5 sm:px-6 sm:py-6 lg:px-8">
          <div className="h-full rounded-lg  ">
            <div className="relative h-full divide-y divide-gray-200 md:grid md:grid-cols-12 md:divide-y-0 md:divide-x">
              <aside className="asideChat absolute w-full divide-y divide-gray-200 bg-white shadow shadow-lg md:relative md:col-span-3 md:shadow-none">
                <div className="flex">
                  <Link
                    href="/messages"
                  ...
                  <div className="flexTo border-transparent text-xl font-extrabold tracking-tight text-gray-900 lg:col-span-2 lg:block">
                    <div className="relative">
                      <input
                        className="mr-3 mt-3.5 ml-3.5 mb-3.5 w-52 rounded-md border-2 py-1.5 pl-8 text-base w-11/12	"
                        placeholder="Search"
                      />
                      <img
                    ...
                    <div className="rounded-md bg-gray-100 mr-5 mt-3.5 mb-3.5 ml-2.5 w-1/5	pl-3.5 pt-2.5">
                      <img
                        className="mt-1"
                        src={'/assets/images/Messages/Star.svg'}
                      />
                    </div>
                  </div>
                </div>
                              ...
                              <div
                                className={classNames(
                                  slug && slug[0] === connection.id
                                    ? 'bg-[#e9eaea94]'
                                    : '',
                                  'relative flex items-center space-x-3 rounded-lg px-6 py-5 focus-within:ring-2 focus-within:ring-inset focus-within:ring-blue-500 hover:bg-gray-50'
                                )}
                              >
                                ...
                                <div className="min-w-0 flex-1">
                                  <p className="flexTo justify-between text-sm font-medium text-gray-900">
                                    <div>
              ...
              <div
                className={classNames(
                  ...
                  'inboxChat h-full divide-y divide-gray-200 pt-14 shadow md:col-span-9 md:pt-0'
                )}
              >
                {chat ? (
