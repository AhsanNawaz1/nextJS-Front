...
function ProfileFilters({ prefix, user, onboardingData }: IProfileFilterProps) {
    ...
    <>
      {filters.map((section: any) => (
        <Disclosure
          ...
          defaultOpen={true}
          className={`border-b border-gray-300 py-5 lg:border-none ${
            section.name === 'Premium' ? 'col-span-2' : ''
                    ...
                    section.options.map((option: any, optionIdx: number) => (
                      ...
                      >
                        ...
                        <label
                          ...
                          className="ml-3 -mt-1 text-sm text-gray-600"
                        >
                          {option.label}
                        </label>
                      </div>
  ...
  return (
    <form className="lg:grid lg:h-72 lg:grid-cols-9 lg:gap-x-4 lg:overflow-hidden xl:gap-x-6">
      {renderFilterList([
        {
          id: 'role',
          name: 'Roles',
          ...
          options: [
            {
              ...
              label: (
                <>
                  Show only Premium{' '}
                  <span className="text-sm text-orange-700 lg:sr-only">〇</span>{' '}
                  users
                </>
              ),
            },
            {
              ...
              label: (
                <>
                  ...
                  <sup className="text-xs font-medium tracking-tighter text-orange-600 lg:sr-only">
                    NEW
                  </sup>
                </>
              ),
      ...
      <div className="flex flex-row items-end justify-start space-x-3 lg:py-5 xl:py-6">
        <Link
          ...
          className=" rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-100"
        >
          Reset
        </Link>
      </div>
