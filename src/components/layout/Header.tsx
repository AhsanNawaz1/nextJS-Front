...
export default function Header(props: IHeaderProps) {
  ...
  const publicFarRight = () => {
    return (
      <>
        ...
        <Link
          href="/register"
          className="ml-8 inline-flex items-center justify-center whitespace-nowrap rounded-md bg-orange-600 px-5 py-2 text-base font-medium text-white transition duration-200 hover:bg-orange-500 active:bg-orange-800"
        >
          Sign up
        </Link>
      </>
  ...
  return (
    <Popover
      className={classNames(
        props.sticky ? 'sticky top-0 z-40 shadow' : 'relative',
        'bg-white'
      )}
    >
      {/* for freemium user */}
